namespace cmap.Benchmarks.Runner
    ...
    let run () =
        ...
        let results =
            [ "STJ serialize", measure 200000 5 Bench.stjSerialize hashString
              "cmap serialize", measure 200000 5 Bench.cmapSerialize hashString
              ...
              "cmap deserialize bytes", measure 200000 5 Bench.cmapDeserializeBytes hashPerson
