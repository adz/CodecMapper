...
module Sentinel =
    ...
    let private testSequence name actual expected =
    ...
    let run platformLabel =
        ...
        let interopJson = Json.serialize interopCodec interop
        let interopDecoded = Json.deserialize interopCodec interopJson
        testSequence "Interop collection resize-array round-trip" interopDecoded.Buffer [ "x"; "y" ]
